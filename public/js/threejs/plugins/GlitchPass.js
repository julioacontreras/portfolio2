...
THREE.GlitchPass.prototype = Object.assign( Object.create( THREE.Pass.prototype ), {
	...
	this.uniforms[ 'tDiffuse' ].value = readBuffer.texture;
		...
		if (this.active) {
			distortion_x = THREE.MathUtils.randFloat( 0, 1 )
			distortion_y = THREE.MathUtils.randFloat( 0, 1 )
		} else {
			distortion_x = 0
			distortion_y = 0
		}
		...
		if ( this.curF % this.randX == 0 || this.goWild == true ) {
			...
			this.uniforms[ 'distortion_x' ].value = distortion_y;
			this.uniforms[ 'distortion_y' ].value = distortion_y;
			this.curF = 0;
			this.generateTrigger();
